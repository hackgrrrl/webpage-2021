  ...
  v-row
    ...
    v-col.pa-0(cols='12' lg='6' style='position: relative')
      ...
      carousel-3d(
        ...
        slide(:index='8')
          v-img(src='../assets/pictures/8.jpg')
        slide(:index='9')
          v-img(src='../assets/pictures/9.jpg')
        slide(:index='10')
          v-img(src='../assets/pictures/10.jpg')
        slide(:index='11')
          v-img(src='../assets/pictures/11.jpg')
        slide(:index='12')
          v-img(src='../assets/pictures/12.jpg')
        slide(:index='13')
          v-img(src='../assets/pictures/13.jpg')
        slide(:index='14')
          v-img(src='../assets/pictures/14.jpg')
        slide(:index='15')
          v-img(src='../assets/pictures/15.jpg')
        slide(:index='16')
          v-img(src='../assets/pictures/16.jpg')
        slide(:index='17')
          v-img(src='../assets/pictures/17.jpg')
        slide(:index='18')
          v-img(src='../assets/pictures/18.jpg')
